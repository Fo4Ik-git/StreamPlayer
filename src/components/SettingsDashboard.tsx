      ...
      try {
          ...
          if (result.success) {
              if (result.data?.user_id) {
                  toast.success(`Connected as: ${result.data.name || 'User'}`);
              } else {
                  ...
                  <div className="md:col-span-2 flex items-center justify-between mt-2">
                       ...
                       <div className="flex gap-2">
                           <button
                               ...
                               disabled={testingDa || !store.donationAlertsClientId || !store.donationAlertsClientSecret}
                               className="bg-zinc-800 hover:bg-zinc-700 disabled:opacity-50 text-white px-4 py-2 rounded-lg transition-colors flex items-center gap-2 text-sm font-medium"
                               title="Test Connection"
                           >
                               {testingDa ? <Loader2 className="w-4 h-4 animate-spin"/> : <CheckCircle2 className="w-4 h-4" />}
                               Test
                           </button>
                           <button
                               ...
                               onClick={() => {
                                   ...
                                   const scope = 'oauth-user-show oauth-donation-index oauth-donation-subscribe';
